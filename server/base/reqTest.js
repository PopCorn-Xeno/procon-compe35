...
const url = {
    home: "http://192.168.10.14:3001",
    knct: "http://192.168.137.203:3001"
}

// request.get(url.home, { json: true }, (error, response) => {
//     if (response) {
//         let q = new Question(null, 4, 4);
//         console.log(q.board);
//     }
// })
